...
class ChaseWaypointGenerator(object):
    ...
    def get_current_waypoint(self):
        ...
        if self._current_waypoint == 0:
            ...
            distance_m = Telemetry.distance_m(
                self._waypoints[self._current_waypoint][0],
                self._waypoints[self._current_waypoint][1],
                self._last_latitude,
    ...
    @staticmethod
    def _circle_intersection(point1, point2, circle_center, circle_radius):
        """Returns an iterable list of the points of intersection between a line
        and a circle, if any.
        """
        # http://mathworld.wolfram.com/Circle-LineIntersection.html
        x_1 = point1[0] - circle_center[0]
        x_2 = point2[0] - circle_center[0]
        y_1 = point1[1] - circle_center[1]
        y_2 = point2[1] - circle_center[1]
        d_x = x_2 - x_1
        d_y = y_2 - y_1
