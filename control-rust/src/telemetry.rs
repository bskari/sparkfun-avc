...
mod tests {
    ...
    use super::{
        difference_d, distance, equatorial_radius_m, is_turn_left, latitude_d_to_m_per_longitude_d,
        relative_degrees, rotate_degrees_clockwise, wrap_degrees, Degrees, Point,
    };
    ...
    where
        T: enum_primitive::FromPrimitive,
    {
    ...
    fn test_relative_degrees() {
        assert_approx_eq(
            relative_degrees(&Point { x: 0.0, y: 0.0 }, &Point { x: 1.0, y: 1.0 }),
            45.0,
        );
        assert_approx_eq(
            relative_degrees(&Point { x: 1.0, y: 1.0 }, &Point { x: 0.0, y: 0.0 }),
            225.0,
        );
        assert_approx_eq(
            relative_degrees(&Point { x: 0.0, y: 0.0 }, &Point { x: 2.0, y: 2.0 }),
            45.0,
        );
        assert_approx_eq(
            relative_degrees(&Point { x: 2.0, y: 2.0 }, &Point { x: 0.0, y: 0.0 }),
            225.0,
        );
        ...
        assert_approx_eq(
            relative_degrees(&Point { x: 0.0, y: 0.0 }, &Point { x: 0.0, y: 1.0 }),
            0.0,
        );
        assert_approx_eq(
            relative_degrees(&Point { x: 0.0, y: 1.0 }, &Point { x: 0.0, y: 0.0 }),
            180.0,
        );
        assert_approx_eq(
            relative_degrees(&Point { x: 0.0, y: 0.0 }, &Point { x: 0.0, y: 2.0 }),
            0.0,
        );
        assert_approx_eq(
            relative_degrees(&Point { x: 0.0, y: 2.0 }, &Point { x: 0.0, y: 0.0 }),
            180.0,
        );

        assert_approx_eq(
            relative_degrees(&Point { x: 0.0, y: 0.0 }, &Point { x: 1.0, y: 0.0 }),
            90.0,
        );
        assert_approx_eq(
            relative_degrees(&Point { x: 1.0, y: 0.0 }, &Point { x: 0.0, y: 0.0 }),
            270.0,
        );
        assert_approx_eq(
            relative_degrees(&Point { x: 0.0, y: 0.0 }, &Point { x: 2.0, y: 0.0 }),
            90.0,
        );
        assert_approx_eq(
            relative_degrees(&Point { x: 2.0, y: 0.0 }, &Point { x: 0.0, y: 0.0 }),
            270.0,
        );
    }
    ...
    fn test_distance() {
        println!("1");
        assert_approx_eq(
            distance(&Point { x: 0.0, y: 0.0 }, &Point { x: 0.0, y: 0.0 }),
            0.0,
        );
        println!("2");
        assert_approx_eq(
            distance(&Point { x: 0.0, y: 0.0 }, &Point { x: 3.0, y: 4.0 }),
            5.0,
        );
        println!("3");
        assert_approx_eq(
            distance(&Point { x: 0.0, y: 0.0 }, &Point { x: 4.0, y: 3.0 }),
            5.0,
        );
        println!("4");
        assert_approx_eq(
            distance(&Point { x: -1.0, y: -3.0 }, &Point { x: 2.0, y: 1.0 }),
            5.0,
        );
        println!("5");
        assert_approx_eq(
            distance(&Point { x: 2.0, y: 1.0 }, &Point { x: -1.0, y: -3.0 }),
            5.0,
        );
    }
}
