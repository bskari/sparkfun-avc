...
tmux send-keys -t sparkfun "sudo ~pi/.virtualenvs/sparkfun/bin/python -m main -l /data/$(date +%Y-%m-%d_%H:%M:%S)-out.log --max-throttle=0.5 -k ~/sparkfun-avc/paths/sparkfun-avc-2015.kmz" c-m
